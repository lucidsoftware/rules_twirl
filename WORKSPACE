...
load("//:test_workspace.bzl", "twirl_test_2_13_repositories", "twirl_test_3_repositories")

twirl_test_3_repositories()

load("@twirl_test_3//:defs.bzl", twirl_test_3_pinned_maven_install = "pinned_maven_install")

twirl_test_3_pinned_maven_install()

twirl_test_2_13_repositories()

load("@twirl_test_2_13//:defs.bzl", twirl_test_2_13_pinned_maven_install = "pinned_maven_install")

twirl_test_2_13_pinned_maven_install()
